 ...
 * @author crisc
 */
public class PokemonInterfaz extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PokemonInterfaz.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
